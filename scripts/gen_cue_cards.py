...
SEGMENTS = [
    ...
    (
        "seg5a-demo-lock", "5a — LIVE DEMO (lock)", "20 sec",
        [
        ...
        "после Done — ждёшь 60s, потом открываешь cue card 5b",
    ),
    (
        "seg5b-demo-reveal", "5b — LIVE DEMO (reveal)", "25 sec",
        [
            ("Sixty seconds pass.", None),
            ("I trigger the reveal.", "trigger"),
            ("Now I call fulfill.", "fulfill"),
            ("The callback checks the signature.", None),
            ("Sets the replay flag.", None),
            ("Writes the value.", None),
            ("SIXTY THREE.", "SIXTY THREE"),
            ("The number stayed secret until the timer.", None),
        ],
        "финал клипа 5 — улыбка в голос",
    ),
    (
