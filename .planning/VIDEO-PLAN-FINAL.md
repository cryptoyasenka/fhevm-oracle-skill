...
- ⚠️ **«A 3-minute video demo to pitching the project (Real-person pitch only. AI-generated video or voice will not be considered.)»**
  - **≤3:00 ровно** (не 3:01)
  - **Голос ТВОЙ** — никакой TTS / ElevenLabs / synthesized voice. Запиши своим голосом.
  - **Real-person pitch** — это «pitching», т.е. ты презентуешь. Чтобы это было железно — **покажи лицо хотя бы в одном сегменте** (например, 5 сек webcam в самом начале или в outro). Screencast в середине — ОК. Полный экранкаст без лица технически проходит «не AI», но webcam убирает любые сомнения судьи.
...
3. Минимум 5 сек webcam где-нибудь (Hook 0:00-0:05 — самое естественное место)
...
### 1.2 Веб-камера + микрофон (для real-person правила)
...
- **Веб-камера**: для 5-секундного интро в Сегменте 1. Освещение спереди (окно днём = идеально), задний фон чистый. Если не хочешь face-cam — голос+screencast технически проходит правило «no AI», но это риск. Безопаснее показать лицо хотя бы 5 сек.
...
### 🎬 Сегмент 1 — Hook (0:00–0:20) — **С ВЕБКАМЕРОЙ**

**Видео:** webcam fullscreen первые 5 сек («real-person» доказательство), потом cross-fade на `slides/01-title.png` оставшиеся 15 сек.
...
### 🎬 Сегмент 6 — Outro (2:45–3:00) — слайд + опционально webcam

**Видео:** статика `slides/06-outro.png` 15 сек. **Опционально:** последние 3 сек закрой webcam fullscreen (усиливает «real-person»).
...
| Видео >3:00 | Режь Сегмент 5 — ускоряй больше места ожидания. НЕ режь Сегмент 1 (там real-person доказательство) |
...
1. **Импорт:** перетащи папку `slides/` в Media. Перетащи 6 кусков screencast'а + webcam-кусок.
...
### Запись
- [ ] Webcam-сегмент (≥5 сек) есть в видео
- [ ] Голос — твой, не TTS
...
- 5 сек webcam «Hi, I'm Yana, this is fhevm-oracle» (real-person доказательство)
...
- 5 сек webcam «thanks Zama» (Сегмент 6)

≈2:10. Покрывает все правила, голос твой, лицо есть, ≤3 мин. Сабмиты в обе формы примут такое видео.
